...
class ECGDataset(Dataset):
    def __init__(self, records_list, data_dir, is_training=True, seq_len=utils.WINDOW_SIZE, windowing_method='qrs'):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # OPTIONAL: Clean signal and correct polarity
            ...
            # OPTIONAL: Normalize each lead between -1 and 1
